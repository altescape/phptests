...
(function() {
  var circle1, circle1a, circle2, circle2a, circle3, circle3a, finished_anim, inner_circle_diam, iter, outer_circle_diam, stage, stroke;
  ...
  circle1.graphics.setStrokeStyle(2).beginStroke("orange");
  ...
  circle1a.graphics.beginFill("rgba(255,255,255,0.5)").drawCircle(0, 0, inner_circle_diam);
  ...
  circle2.graphics.setStrokeStyle(2).beginStroke("orange");
  ...
  circle2a.graphics.beginFill("rgba(255,255,255,0.5)").drawCircle(0, 0, inner_circle_diam);
  ...
  circle3.graphics.setStrokeStyle(2).beginStroke("orange");
  ...
  circle3a.graphics.beginFill("rgba(255,255,255,0.5)").drawCircle(0, 0, inner_circle_diam);
  ...
  stroke = function(event) {
    ...
    return typeof console !== "undefined" && console !== null ? console.log(iter) : void 0;
  };
